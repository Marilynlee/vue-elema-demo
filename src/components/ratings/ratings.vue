<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect :properties="{selectType:selectType,onlyContent:onlyContent,desc:desc}" :ratings="ratings"
                     @ratingType="ratingType" @onlyContType="onlyContType"></ratingselect>
      <div class="ratings-wrapper">
        <ul>
          <li v-for="(rating, index) in ratings" :key="index" v-show="needShow(rating)" class="rating-item">
            <div class="avatar">
    ...
    created() {
      this.$http.get('/api/ratings').then((response) => {
        ...
        if (response.errno === ERR_OK) {
          ...
          console.log('get ratings: ', this.ratings);
        }
        this.$nextTick(() => {
