    ...
    <div class="content-wrap">
      ...
      <div class="content">
        ...
        <div v-if="seller.supports" class="support">
          <imgText
            :pros="{show:'true',size:'12',type:seller.supports[0].type,bg:'nobg',text:seller.supports[0].description}"
          ></imgText>
        </div>
      </div>
          ...
          <div class="detail-main">
            ...
            <ul class="support" v-if="seller.supports">
              <li class="support-item" v-for="(item,index) in seller.supports" :key="index">
                <imgText
                  :pros="{show:true,size:'16',type:item.type,bg:'nobg',text:item.description}"
                ></imgText>
              </li>
            </ul>
            <div class="title">
